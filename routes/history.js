...
const {saveHistory,getHistory,shareHistory ,deleteAllHistory} = require('../controller/history');
...
router.delete('/delete',isAuthenticated , restrictToAuthenticated,  deleteAllHistory); // Delete all history for user
